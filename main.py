...
class App:
    def __init__(self):
        ...
        self.main_window.geometry("1200x720+350+100")
        ...
        self.webcam_label.place(x=20, y=50, width=640, height=360)
        ...
        self.db_dir1 = './persons'
        if not os.path.exists(self.db_dir1):
            os.mkdir(self.db_dir1)
    ...
    def accept_register_new_user(self):
        ...
        cv2.imwrite(os.path.join(self.db_dir1,'{}.jpg'.format(name)),self.register_new_user_capture)
